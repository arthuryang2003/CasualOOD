...
from common.modules.networks import CasualOOD, ERMNet
...
from train import CasualOOD_train, CasualOOD_finetune, CasualOOD_train1, ERM_train
...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.train_epochs):
        ...
        with open(test_logger, 'a') as f:
            f.write(f"(epoch {epoch+1}): ERM Val Acc {acc:.3f}\n")
