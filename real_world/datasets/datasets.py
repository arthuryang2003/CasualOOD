...
class VLCS(MultipleEnvironmentImageFolder):
    ...
    def __init__(self, root, target, args):
        ...
        super().__init__(self.dir, target, args.data_augmentation, args)
...
class WILDSDataset(MultipleDomainDataset):
    INPUT_SHAPE = (3, 224, 224)
    def __init__(self, dataset, metadata_name, target, augment, args):
        super().__init__()
        ...
        for i, metadata_value in enumerate(
            ...
            if augment and (i not in target):
                env_transform = augment_transform
            else:
                env_transform = transform
...
class WILDSCamelyon(WILDSDataset):
    ...
    def __init__(self, root, target, args):
        ...
        super().__init__(
            dataset, "hospital", target, args.data_augmentation, args)
...
class WILDSFMoW(WILDSDataset):
    ...
    def __init__(self, root, target, args):
        ...
        super().__init__(
            dataset, "region", target, args.data_augmentation, args)
...
class SpawriousO2O_easy(SpawriousBenchmark):
    def __init__(self, root_dir, target, args):
        group = ["desert","jungle","dirt","snow"]
        test = ["dirt","snow","desert","jungle"]
        filler = "beach"
        combinations = self.build_type1_combination(group,test,filler)
        super().__init__(combinations['train_combinations'], combinations['test_combinations'], root_dir, args.data_augmentation, type1=True)
...
class SpawriousM2M_easy(SpawriousBenchmark):
    def __init__(self, root_dir, target, args):
        ...
        super().__init__(combinations['train_combinations'], combinations['test_combinations'], root_dir, args.data_augmentation) 
